...
internal void
render_rect(int x0, int y0, int x1, int y1, u32 color) {
...
draw_arena_borders(float arena_x, float arena_y, u32 color) {
	...
	render_rect(0, 0, render_state.width, y0, color);
	render_rect(0, y1, x1, render_state.height, color);
	render_rect(0, y0, x0, y1, color);
	render_rect(x1, y0, render_state.width, render_state.height, color);
}
